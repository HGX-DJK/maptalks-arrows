...
var StraightArrow = function (_maptalks$Curve) {
    ...
    StraightArrow.prototype.setArrowConfig = function setArrowConfig(config) {
    ...
    StraightArrow.prototype._getPaintParams = function _getPaintParams() {
        ...
        var arrowPairs = getArrowBody(points, lineWidth, map);
        ...
        var hScale1 = typeof arrowConfig.hScale1 !== 'undefined' ? arrowConfig.hScale1 : 2.2;
        var hScale2 = typeof arrowConfig.hScale2 !== 'undefined' ? arrowConfig.hScale2 : 0.7;
        var h1h2Ratio = typeof arrowConfig.h1h2Ratio !== 'undefined' ? arrowConfig.h1h2Ratio : 2.3;

        var arrowHead = this._getArrowHead(h1, h2, points, lineWidth, lineRatio, f1, f2, hScale1, hScale2, h1h2Ratio);
    ...
    StraightArrow.prototype._getArrowHead = function _getArrowHead(h1, h2, points, lineWidth, lineRatio, f1, f2, hScale1, hScale2, h1h2Ratio) {
        ...
        if (points.length === 2) {
            ...
            var headPoint = new maptalks.Point(lastPoint.x + direction.x * h1h2Length * h1h2Ratio, lastPoint.y + direction.y * h1h2Length * h1h2Ratio);
...
maptalks.DrawTool.registerMode('StraightArrow', {
    ...
    update: function update(projection, prjPath, geometry) {
        var prjCoords = Array.isArray(prjPath) ? prjPath : geometry._getPrjCoordinates().concat(prjPath);
...
DoveTailDiagonalArrow.mergeOptions(options$1);
...
maptalks.DrawTool.registerMode('GatheringPlace', {
    action: ['click', 'mousemove', 'dblclick'],
    create: function create(projection, prjPath) {
        var path = prjPath.map(function (c) {
            return projection.unproject(c);
...
exports.GatheringPlace = GatheringPlace;
